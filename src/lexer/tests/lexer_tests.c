...
Test(lexer, lexer_pop_simple)
{
    ...
    cr_assert_eq(lexer->index, 16, "index = %lu", lexer->index);
    token_free(token);
...
Test(Lexer, complex_single_quotes_backslash)
{
    ...
    cr_assert_str_eq(token.data, "''dkd'", "token.data = %s", token.data,
                     "token.data = %s", token.data);
    cr_assert_eq(lexer->index, 15, "lexer->index = %lu", lexer->index,
...
Test(Lexer, multiple_spaces)
{
    ...
    cr_assert_eq(token.type, TOKEN_WORD, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    cr_assert_str_eq(token.data, "test", "token.data = %s", token.data,
                     "token.data = %s", token.data);
    cr_assert_eq(lexer->index, 11, "lexer->index = %lu", lexer->index,
                 "lexer->index = %lu", lexer->index);
    token_free(token);
...
Test(Lexer, lexer_if_then)
{
    ...
    cr_assert_eq(token.type, TOKEN_IF, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    cr_assert_str_eq(token.data, "if", "token.data = %s", token.data,
                     "token.data = %s", token.data);
    cr_assert_eq(lexer->index, 3, "lexer->index = %lu", lexer->index,
                 "lexer->index = %lu", lexer->index);
    token_free(token);
    ...
    token = lexer_pop(lexer);
    cr_assert_eq(token.type, TOKEN_THEN, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    ...
    token = lexer_pop(lexer);
    cr_assert_eq(token.type, TOKEN_FI, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    ...
    token = lexer_pop(lexer);
    cr_assert_eq(token.type, TOKEN_SEMICOLON, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    cr_assert_str_eq(token.data, ";", "token.data = %s", token.data,
                     "token.data = %s", token.data);
...
Test(Lexer, lexer_elif)
{
    ...
    struct token token = lexer_pop(lexer);
    cr_assert_eq(token.type, TOKEN_ELIF, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    cr_assert_str_eq(token.data, "elif", "token.data = %s", token.data,
                     "token.data = %s", token.data);
    cr_assert_eq(lexer->index, 5, "lexer->index = %lu", lexer->index,
                 "lexer->index = %lu", lexer->index);
    token_free(token);
...
Test(Lexer, lexer_else)
{
    ...
    struct token token = lexer_pop(lexer);
    cr_assert_eq(token.type, TOKEN_ELSE, "token.type = %d", token.type,
                 "token.type = %d", token.type);
    cr_assert_str_eq(token.data, "else", "token.data = %s", token.data,
                     "token.data = %s", token.data);
    cr_assert_eq(lexer->index, 4, "lexer->index = %lu", lexer->index,
                 "lexer->index = %lu", lexer->index);
    token_free(token);
...
Test(Lexer, only_one_single_quote)
{
    ...
    cr_assert_str_eq(token.data, "get_word - Missing closing quote.",
                     "token.data = %s", token.data);
